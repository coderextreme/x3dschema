    ...
    public X3D initialize() {
      ...
      .setScene(new Scene()
        ...
        .addChild(new HAnimHumanoid().setName("JinLOA4").setDEF("hanim_JinLOA4").setLoa(4).setScale(new float[] {0.0225f ,0.0225f ,0.0225f }).setVersion("2.0")
          ...
          .addSkeleton(((HAnimJoint)new HAnimJoint("hanim_JinLOA4").setName("humanoid_root").setDEF("hanim_humanoid_root").setCenter(new float[] {0f ,36.709999f ,-0.7076f }).setUlimit(new MFFloat6().getArray()).setLlimit(new MFFloat7().getArray()).setContainerFieldOverride("skeleton"))
