...
var X3dJsonSchema = JSON.parse(fs.readFileSync('/Users/johncarlson/Downloads/x3d-code/www.web3d.org/specifications/x3d-3.3-JSONSchema.json').toString());
...
function validateFile(file) {
	try {
		...
		if (!valid) {
		    console.log('Ajv Validation failed on', file);
		...
		if (!errors) {
			...
			console.log('jjv Validation failed on', file);
		...
		if (valid2) {
		    ...
		    console.log('is-my-json-valid Validation failed on', file);
